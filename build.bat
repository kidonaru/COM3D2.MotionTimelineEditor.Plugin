...
set LIB_PATHS="/lib:..\..\COM3D2x64_Data\Managed" "/lib:.." "/lib:..\..\BepInEx\plugins\UnityInjectorLoader"
set REFERENCES="/r:UnityEngine.dll" "/r:BepInEx.UnityInjectorLoader.dll" "/r:Assembly-CSharp.dll" "/r:Assembly-CSharp-firstpass.dll" "/r:ExIni.dll"
