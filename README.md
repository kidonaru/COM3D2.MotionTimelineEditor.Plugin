...
パーツエディットプラグインでモデルのボーンを操作することができます。
...
- モデルのボーン/シェイプのタイムライン対応
  - DCM出力には対応していません
- モデルのアタッチ変更機能
  - アタッチしているモデルのボーンはPartsEditで編集できないので、情報ウィンドウから変更してください
- モデルの設定ウィンドウ追加
