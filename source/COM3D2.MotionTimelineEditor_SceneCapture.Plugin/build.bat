...
set PLUGIN_NAME=COM3D2.MotionTimelineEditor_SceneCapture.Plugin
...
set REFERENCES="/r:UnityEngine.dll" "/r:UnityInjector.dll" "/r:Assembly-CSharp.dll" "/r:Assembly-CSharp-firstpass.dll" "/r:COM3D2.MotionTimelineEditor.Plugin.dll" "/r:COM3D2.SceneCapture.Plugin.dll"
set SOURCE_DIR=%~dp0
